                            ...
                            <ul class="submenu">
                                ...
                                <li class="active menu_item_has_child">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="active"><a href="sign_in.html">Bem Vindo</a></li>
                                    </ul>
                                </li>
            ...
            <ul class="clearfix">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="sign_in.html">Bem Vindo</a></li>
                        <li><a href="sign_up.html">Bem Vindo</a></li>
                        <li><a href="404.html">404</a></li>
                    </ul>
                </li>
    ...
    <section id="breadcrumb_section" class="breadcrumb_section bg_gradient_blue deco_wrap d-flex align-items-center text-white clearfix">
        <div class="container">
            <div class="breadcrumb_content text-center" data-aos="fade-up" data-aos-delay="100">
                <h1 class="page_title">Bem Vindo</h1>
                <p class="mb-0">
            ...
            <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
                ...
                <div class="col-lg-6 col-md-7 col-sm-8">
                    <div class="section_title increase_size mb-80" data-aos="fade-up" data-aos-delay="400">
                        <h2 class="title_text mb-30">Entrar</h2>
                        <p class="mb-0">
                            
Receber! Por favor, confirme que você está visitando
                            <span class="d-block"><a href="#!">https://github.com/alfredo1995</a></span>
                        </p>
                    </div>
                    ...
                    <div class="reg_form signin_form" data-aos="fade-up" data-aos-delay="500">
                        <form action="{{ route('site.login') }}" method="post">
                            ...
                            <div class="form_item">
                                ...
                                <input type="text" name="usuario" value="{{ route('site.login')}}" placeholder="usuario">
                            </div>

                            <div class="form_item">
                                <h4 class="input_title">senha</h4>
                                <input type="password" name="senha" value="{{ route('site.login')}}" placeholder="**********">
                            </div>
                            ...
                            <button type="submit" class="btn bg_default_blue mb-30">Acessar</button>

                            <p class="mb-0 text-center">
                                New User? <a href="#!"><u>Sign up here</u></a>
                            </p>
